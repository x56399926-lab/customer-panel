...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Radhe Radhe Cafe — Order food online" },
      {
        name: "description",
        content:
          "Order home-style Indian food from Radhe Radhe Cafe. Biryani, curries, Chinese, snacks and desserts delivered hot.",
      },
      { name: "author", content: "Radhe Radhe Cafe" },
      { property: "og:title", content: "Radhe Radhe Cafe — Order food online" },
      {
        property: "og:description",
        content: "Biryani, curries, Chinese, snacks and desserts delivered hot to your door.",
      },
